...
class Defend_Pain : PainCustomCard(ID, COST, AbstractCard.CardType.SKILL, AbstractCardEnum.THE_PAIN_MAROON, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.SELF) {
    init {
